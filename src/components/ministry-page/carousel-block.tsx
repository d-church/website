...
export default function CarouselBlock({
  ...
  return (
    <>
      ...
      <div
        className="custom-scrollbar mx-auto mt-[20px] pr-[18px] max-w-[1070px] text-center text-[1.25rem]/[1.875rem] font-medium max-xl:w-[90%] max-lg:pb-[150px] lg:mt-[50px] max-h-[300px] overflow-y-auto"
