...
export function PaymentMethodsBlock() {
  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-4">
        <div className="group rounded-sm border border-gray-200 p-5 shadow-md transition-all duration-300 hover:shadow-lg">
          <div className="flex flex-col lg:flex-row lg:items-start lg:space-x-8">
            <div className="flex items-center space-x-6 lg:mb-0">
              <div>
                <Image
                  className="mb-3"
        ...
        <div className="group flex flex-col justify-between rounded-sm border border-gray-200 p-5 shadow-md transition-all duration-300 hover:shadow-lg">
          ...
          />
          <p className="mb-6 leading-relaxed text-gray-600">
            {t("donate-page.payments-block.paypal-desc")}
          </p>
          <div>
            <a
        ...
        <div className="group flex flex-col justify-between rounded-sm border border-gray-200 p-5 shadow-md transition-all duration-300 hover:shadow-lg">
          <Image
            className="mb-4"
            src="/static/liqpay_for_white.png"
            alt=""
            width={160}
            height={50}
          />
      ...
      <div className="rounded-sm border border-gray-200 p-5 shadow-md transition-all duration-300 hover:shadow-lg">
