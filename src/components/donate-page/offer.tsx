...
export function Offer() {
  ...
  return (
    <div className="hidden xl:flex w-full h-[200px]  items-center p-[50px] bg-[#232323] rounded-[20px] text-[20px]">
      ...
      <Link href="/static/public-offer.pdf" className='h-[44px] w-[184px] text-white uppercase text-center py-[5px] px-[20px] border rounded-[22px] border-white hover:bg-white hover:text-[#0E9398]'>
        {t("btn")}
      </Link>
    </div>
  )
