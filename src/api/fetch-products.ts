...
const OneEntryProjectLink =
  process.env.NEXT_PUBLIC_ONEENTRY_PROJECT_LINK || "https://sourceoflife.oneentry.cloud";
...
export const fetchProducts = (keyType: TKeyType = "Ministry") => {
  ...
  return Products.getProducts(body);
};
...
// Re-export fetchPostById for backward compatibility
export { fetchPostById } from "./fetch-posts";
